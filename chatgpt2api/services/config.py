...
class ConfigStore:
    ...
    @property
    def hourly_account_scan_enabled(self) -> bool:
        self.reload_if_changed()
        return _normalize_bool(self.data.get("hourly_account_scan_enabled"), False)
    ...
    def get(self) -> dict[str, object]:
        with self._lock:
            ...
            data["hourly_account_scan_enabled"] = self.hourly_account_scan_enabled
